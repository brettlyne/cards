<svg
  ...
  ><rect
    ...
    fill="white"
    stroke="black"
  ></rect><use xlink:href="#VC2" height="32" width="32" x="-114.4" y="-156"
  ></use><use xlink:href="#VC2" height="32" width="32" x="82.4" y="-156"
  ></use><use
    xlink:href="#SC2"
    height="26.769"
    width="26.769"
  ...
  ></use><use
    ...
    x="85.016"
    y="-119"
  ></use><use xlink:href="#SC2" height="70" width="70" x="-35" y="-135.588"
  ></use><g transform="rotate(180)"
    ><use xlink:href="#VC2" height="32" width="32" x="-114.4" y="-156"
    ></use><use xlink:href="#VC2" height="32" width="32" x="82.4" y="-156"
    ></use><use
      xlink:href="#SC2"
      height="26.769"
